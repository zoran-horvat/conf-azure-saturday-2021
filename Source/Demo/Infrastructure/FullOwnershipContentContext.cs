...
namespace Demo.Infrastructure
{
    public class FullOwnershipContentContext
        : TenancyContentContext, IDbContext<Product>, IDbContext<FriendConnection>, IContentReadContext
    {
        public FullOwnershipContentContext(ContentContext context, TenancyProvider tenancyProvider) 
